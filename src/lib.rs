...
#[derive(Debug)]
pub struct SandProxyProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SandProxyProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SandProxy processing");
    
    let mut processor = SandProxyProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SandProxyProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SandProxyProcessor::new(false);
